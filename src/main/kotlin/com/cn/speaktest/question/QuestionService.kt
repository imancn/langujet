...
class QuestionService(
    ...
    fun createTextQuestion(questionRequest: TextQuestionRequest): Question.Text {
        return questionRepository.save(
            checkNotExist(questionRequest.toQuestion(
    ...
    fun updateMultipleChoiceQuestion(id: String, questionRequest: MultipleChoiceQuestionRequest): Question.MultipleChoice? {
